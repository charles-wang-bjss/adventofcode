...
test1 = """turn off 660,55 through 986,197
...
test2 = """turn on 0,0 through 999,999
toggle 0,0 through 999,0
turn off 499,499 through 500,500"""


def turn_on(lights, start_x, start_y, finish_x, finish_y):
    for i in range(start_x, finish_x+1):
        for j in range(start_y, finish_y+1):
            lights[i][j] += 1


def turn_off(lights, start_x, start_y, finish_x, finish_y):
    for i in range(start_x, finish_x+1):
        for j in range(start_y, finish_y+1):
            if lights[i][j] > 0:
                lights[i][j] -= 1
...
def toggle(lights, start_x, start_y, finish_x, finish_y):
    for i in range(start_x, finish_x+1):
        for j in range(start_y, finish_y+1):
            lights[i][j] += 2
